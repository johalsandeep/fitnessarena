...
class NutritionViewController: UIViewController {
    ...
    var name = ["Protein","Carbohydrates","Vitamins","Fats", "Minerals", "Water", "Recipe"]
...
""", "add sugar"]
    ...
    // this allows to pass date from cell to new view controller
...
extension NutritionViewController: UITableViewDelegate, UITableViewDataSource {
     ...
     func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
       ...
       //  cell.frame.divided(atDistance: 10, from: CGRectEdge(x: 20, y: 20, width: 100, height: 100))
         ...
         cell.viewContain.layer.cornerRadius = 18
